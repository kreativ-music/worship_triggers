...
CHANNEL = 0 #I have this set to midi channel 2 (which corresponds to 1
...
##RED BOX Control
GRIDSIZE = [10,10] ##the red box grid size(does not have to be square)
...
NAV_BUTTONS = [72,73,74,75,76,77,78,79]
SCENE_BUTTONS = [60,61,62,63,64,65,66,67,100,101]
